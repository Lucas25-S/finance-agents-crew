    ...
    <div class="navbar">
        @if (session('auth_user'))
            <div class="user-info">
                ...
                <div>
                    <strong>{{ session('auth_user')->name }}</strong><br>
                    <span style="font-size: 0.8rem;">{{ session('auth_user')->email }}</span>
                </div>
            </div>
            ...
            <div class="dropdown-menu" id="dropdownMenu">
                <a href="{{ route('curadoria.index') }}" class="menu-item">
                    <i class="fas fa-rocket"></i>
                    Painel de Curadoria
                </a>
                <form action="{{ route('auth.logout') }}" method="POST" style="width: 100%;">
                    @csrf
